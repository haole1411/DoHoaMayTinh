...
public class checker extends GLCanvas {
	...
	myGL.glTexImage2D (GL.GL_TEXTURE_2D, 0, 3, checkImageWidth,
	    checkImageHeight, 0, GL.GL_RGB, GL.GL_UNSIGNED_BYTE, checkImage);
	...
	checker mainCanvas = new checker ();
	mainCanvas.init();
